...
import "./modules/globals/svg";
import "./modules/globals/ui";
import "./modules/globals/style";
...
import Delaunator from "./libs/delaunator.min.js";
import Voronoi from "./modules/voronoi.js";
import polylabel from "./libs/polylabel.min.js";
...
Object.assign(window, {
  ...
  modules: {},
  notes: [],
  // initial grapg based on jittered square grid and data
  grid: {},
  // packed graph and data
  pack: {},
  // 0 - no; 1 = heightmap draw; 2 - states draw; 3 - add state/burg; 4 - cultures draw
  customization: 0,
  // line-clip
  lineclip,
  polygonclip,
...
function defineMapSize() {
  ...
  if (randomize || !"mapSize") mapSizeOutput.value = mapSizeInput.value = size;
